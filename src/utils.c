...
/*   Updated: 2025/01/22 19:27:17 by jgrigorj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_target_index(t_stack *stack, int num)
{
	...
	max_index = 0;
	min_index = 0;
	if (num > get_max_value(stack, &max_index))
		target_index = max_index;
	if (num < get_min_value(stack, &min_index))
	{
		...
		get_index_inbetween(stack, num, max_index);
	return (target_index);
}
